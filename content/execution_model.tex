...
\newtext{An OpenSHMEM team is a group of PEs that communicate, as described in
Section~\ref{subsec:team}.  Each PE is a member of at least one team.}
The \acp{PE} of the \openshmem \newtext{team} are identified by unique integers.  The
