...
{\color{Green}
    \begin{tabular}{|l|l|l|l|l|}
      \hline
      OPTYPE op           & Indicates operation \\ \hline
      SHMEM\_REDUCE\_AND  & Bitwise AND reduction \\ \hline
      SHMEM\_REDUCE\_OR   & Bitwise OR reduction \\ \hline
      SHMEM\_REDUCE\_XOR  & Bitwise exclusive OR (XOR) reduction \\ \hline
      SHMEM\_REDUCE\_MAX  & Performs a maximum-value reduction \\ \hline
      SHMEM\_REDUCE\_MIN  & Performs a minimum-value reduction \\ \hline
      SHMEM\_REDUCE\_SUM  & Performs a sum reduction \\ \hline
      SHMEM\_REDUCE\_PROD & Performance a product reduction \\ \hline
    \end{tabular}
    \TableCaptionRef{Reduction Operation Library Constants}
    \label{reduceops}
}
  \end{center} 
\end{table}
...
\paragraph{Team based generic reduction}

{\color{Green}
All reduction operations can be handled with a single interface function using the C11 generic interface. In this case, the \source{} and \dest{} types must be the same, and determine the operation type as one from Table \ref{reducetypes}. The operation is indicated by the generic typed operation argument, which is one of the handles summarized in Table \ref{reduceops}.

\begin{C11synopsis}
int @\FuncDecl{shmem\_reduce\_to\_all}@(shmem_team_t team, OPTYPE op, TYPE *dest, const TYPE *source, int nreduce);
\end{C11synopsis}
where where op is one of the operation handles in Table \ref{reduceops} and \TYPE{} is one of the types supported for that operation as specified by Table \ref{reducetypes}.
}
...
{\color{Green}
\begin{CsynopsisCol}
int @\FuncDecl{shmem\_team\_\FuncParam{TYPENAME}\_and\_to\_all}@(shmem_team_t team, TYPE *dest, const TYPE *source, int nreduce);
\end{CsynopsisCol}
}
...
{\color{Green}
\begin{CsynopsisCol}
int @\FuncDecl{shmem\_team\_\FuncParam{TYPENAME}\_or\_to\_all}@(shmem_team_t team, TYPE *dest, const TYPE *source, int nreduce);
\end{CsynopsisCol}
}
\begin{DeprecateBlock}
\begin{CsynopsisCol}
...
{\color{Green}
\begin{CsynopsisCol}
int @\FuncDecl{shmem\_team\_\FuncParam{TYPENAME}\_xor\_to\_all}@(shmem_team_t team, TYPE *dest, const TYPE *source, int nreduce);
\end{CsynopsisCol}
}
\begin{DeprecateBlock}
\begin{CsynopsisCol}
...
{\color{Green}
\begin{CsynopsisCol}
int @\FuncDecl{shmem\_team\_\FuncParam{TYPENAME}\_max\_to\_all}@(shmem_team_t team, TYPE *dest, const TYPE *source, int nreduce);
\end{CsynopsisCol}
}
\begin{DeprecateBlock}
\begin{CsynopsisCol}
...
{\color{Green}
\begin{CsynopsisCol}
int @\FuncDecl{shmem\_team\_\FuncParam{TYPENAME}\_min\_to\_all}@(shmem_team_t team, TYPE *dest, const TYPE *source, int nreduce);
\end{CsynopsisCol}
}
\begin{DeprecateBlock}
\begin{CsynopsisCol}
...
{\color{Green}
\begin{CsynopsisCol}
int @\FuncDecl{shmem\_team\_\FuncParam{TYPENAME}\_sum\_to\_all}@(shmem_team_t team, TYPE *dest, const TYPE *source, int nreduce);
\end{CsynopsisCol}
}
\begin{DeprecateBlock}
\begin{CsynopsisCol}
...
{\color{Green}
\begin{CsynopsisCol}
int @\FuncDecl{shmem\_team\_\FuncParam{TYPENAME}\_prod\_to\_all}@(shmem_team_t team, TYPE *dest, const TYPE *source, int nreduce);
\end{CsynopsisCol}
}
\begin{DeprecateBlock}
\begin{CsynopsisCol}
...
\apiargument{IN}{op}{The operation to perform. From Table \ref{reduceops}}%
}
