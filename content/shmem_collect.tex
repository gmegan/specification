...
{\color{Green}
\begin{C11synopsis}
int @\FuncDecl{shmem\_collect\FuncParam{SIZE}}@(shmem_team_t team, void *dest, const void *source, size_t nelems);
int @\FuncDecl{shmem\_fcollect\FuncParam{SIZE}}@(shmem_team_t team, void *dest, const void *source, size_t nelems);
\end{C11synopsis}
...
{\color{Green}
\begin{CsynopsisCol}
int @\FuncDecl{shmem\_team\_collect\FuncParam{SIZE}}@(shmem_team_t team, void *dest, const void *source, size_t nelems);
int @\FuncDecl{shmem\_team\_fcollect\FuncParam{SIZE}}@(shmem_team_t team, void *dest, const void *source, size_t nelems);
\end{CsynopsisCol}
where \SIZE{} is one of \CONST{32, 64}.

\begin{CsynopsisCol}
int @\FuncDecl{shmem\_team\_\FuncParam{TYPENAME}\_collect}@(shmem_team_t team, TYPE *dest, const TYPE *source, size_t nelems);
int @\FuncDecl{shmem\_team\_\FuncParam{TYPENAME}\_fcollect}@(shmem_team_t team, TYPE *dest, const TYPE *source, size_t nelems);
\end{CsynopsisCol}
